...
export LANG=C
export SOURCE_DATE_EPOCH=1538184176
python3 setup.py build

%install
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/Theano
cp LICENSE.txt %{buildroot}/usr/share/doc/Theano/LICENSE.txt
cp doc/LICENSE.txt %{buildroot}/usr/share/doc/Theano/doc_LICENSE.txt
...
/usr/share/doc/Theano/LICENSE.txt
/usr/share/doc/Theano/doc_LICENSE.txt
